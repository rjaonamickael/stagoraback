...
public class User {
    ...
    private String confirmationToken; // Ajout pour la confirmation d'inscription
    private String resetToken;        // Ajout pour la réinitialisation du mot de passe
	...
	public User(Long id, String email, String phone, String sel, String mot_de_passe, boolean confirme,
			String confirmationToken, String resetToken, TypeCompte typeCompte, Etudiant etudiant, Employeur employeur,
			Connexion connexion) {
		super();
		this.id = id;
		this.email = email;
